/***********************************************************************************
                            ...
                            DS Lab Final Term Assignment Submission
...
//req 4. -> Doctor Allocation (Binary Search Tree)
class DoctorNode {
public:
    int doctorID;
    string name;
    ...
    for (int i = 0; i < postfixExpression.length();++i)
    {
        ...
        else if (temp == '+' || temp == '-' || temp == '*' || temp == '/' || temp == '^')
        {
            ...
            case '^':
                operationResult = 1;
                //didnt use <cmath> pow(!!)
                //this loop colculates power equation
...
int main() {
    ...
    */
    ...
    PatientManagement.removePatientByName("Fairuz");// NOT IN THE PATIENT Linked LIST, it was poped first
    PatientManagement.displayPatientDetail();
